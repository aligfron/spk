                            ...
                            <tbody>
                                ...
                                foreach (\App\Controllers\api::nilai_alter1() as $z) { ?>
                                    <tr>
                                        ...
                                        <?php $w1 = \App\Controllers\api::perkalianbobot2();
                                        $alam2 = ($z[2] / $z11[1]) * $w1[0]; ?>
                                        <td align="center"><?= $alam2; ?></td>
                                        <?php $w2 = \App\Controllers\api::perkalianbobot3();
                                        $alam3 = ($z[3] / $z11[2]) * $w2[0]; ?>
                                        <td align="center"><?= $alam3; ?></td>
                                        <?php $w3 = \App\Controllers\api::perkalianbobot4();
                                        $alam4 = ($z[4] / $z11[3]) * $w3[0]; ?>
                                        <td align="center"><?= $alam4; ?></td>
                                        <?php $w4 = \App\Controllers\api::perkalianbobot5();
                                        $alam5 = ($z[5] / $z11[4]) * $w4[0]; ?>
                                        <td align="center"><?= $alam5; ?></td>
                                        <?php $w5 = \App\Controllers\api::perkalianbobot6();
                                        $alam6 = ($z[6] / $z11[5]) * $w5[0]; ?>
