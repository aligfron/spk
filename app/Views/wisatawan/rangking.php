...
if ($hasil_wisatawan) {
    $No = 1;
    foreach (\App\Controllers\api::nilai_alter_w3() as $z) {
...
<?php
echo '<hr><h5><span class="fas fa-sliders-h"></span> Berikut Merupakan Rangking Wisata Buatan</h5>';
?>
<br>
<div class="accordion">
...
<?php $No = 1;
foreach (\App\Controllers\api::rank_alter_w3() as $rank1) {
    $id_wisata = $rank1['3'];
?>
