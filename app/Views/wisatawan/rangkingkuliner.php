...
if ($hasil_wisatawan) {
    $No = 1;
    foreach (\App\Controllers\api::nilai_alter_w4() as $z) {
...
<?php
echo '<hr><h5><span class="fas fa-sliders-h"></span> Berikut Merupakan Rangking Wisata Kuliner</h5>';
?>
<br>
<div class="accordion">
...
<?php $No = 1;
foreach (\App\Controllers\api::rank_alter_w4() as $rank4) {
    $id_wisata = $rank4['3'];
?>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header">
                ...
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#121213" aria-expanded="false" aria-controls="collapseTwo">
                    &emsp;&emsp;<td><?= $rank4['2'] ?></td>&emsp;&emsp;&emsp;&emsp;&emsp;<td><?= $rank4['0'] ?></td>
                    &emsp;
                </button>
            </h2>
