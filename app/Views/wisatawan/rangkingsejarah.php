...
if ($hasil_wisatawan) {
    $No = 1;
    foreach (\App\Controllers\api::nilai_alter_w2() as $z) {
...
<?php
echo '<hr><h5><span class="fas fa-sliders-h"></span> Berikut Merupakan Rangking Wisata Sejarah</h5>';
?>
<br>
<div class="accordion">
...
<?php $No = 1;
foreach (\App\Controllers\api::rank_alter_w2() as $rank2) {
    $id_wisata =  $rank2['3'];
?>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header">
                ...
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#121213" aria-expanded="false" aria-controls="collapseTwo">
                    &emsp;&emsp;<td><?= $rank2['2'] ?></td>&emsp;&emsp;&emsp;&emsp;&emsp;<td><?= $rank2['0'] ?></td>
                    &emsp;
                </button>
            </h2>
